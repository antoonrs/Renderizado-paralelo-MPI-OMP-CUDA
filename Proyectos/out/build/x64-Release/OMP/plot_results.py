...
and total_time frente a cada variable: strategy, nFotogramas, width, height, ns y nThreads.
...
def main():
    ...
    variables = {
        ...
        'nThreads':    sorted(df['nThreads'].unique()),
    }
    ...
    # 8) Diagramas de quesitos: recuentos y medias
    for var in variables.keys():
    ...
    # 9) Estadísticas descriptivas por grupo: mean, median, std
    for var in variables.keys():
        for metric in metrics:
